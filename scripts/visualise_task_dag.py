...
TODO: DECIDE HOW DEPENDENCIES SHOULD LIFT THROUGH TASK SPLITS. IF ALOVYA-90
DEPENDS ON ALOVYA-89, AND ALOVYA-89 IS LATER SPLIT INTO SIBLINGS OR CHILDREN,
DEFINE WHETHER ALOVYA-90 DEPENDS ON THE WHOLE SPLIT GROUP, THE FIRST CHILD, THE
LAST CHILD, ALL CHILDREN, OR AN EXPLICIT SUCCESSOR TASK. ALSO DEFINE THE
OPPOSITE CASE: IF ALOVYA-89 DEPENDS ON ALOVYA-90, AND ALOVYA-90 IS SPLIT INTO
SIBLINGS OR CHILDREN, DECIDE WHICH NEW TASK OR GROUP SATISFIES ALOVYA-89'S
DEPENDENCY.
"""
